                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                    <div className="lg:py-24">
                      ...
                      <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl"></p>
                      <div className="mt-10 sm:mt-12">
                        ...
                        >
                          ...
                          <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                            All players get unlimited access to the latest
                            tournaments and past event results. All completely
                            free.{" "}
            ...
            <div className="max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
              <div className="mt-12 border-t border-gray-200 py-8">
                <p className="text-base text-gray-400 xl:text-center">
                  &copy; 2021 The Chess Centre All rights reserved.
                </p>
              </div>
            </div>
          </footer>
